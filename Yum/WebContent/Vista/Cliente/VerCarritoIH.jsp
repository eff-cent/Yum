...
<body>
	...
	<table border="0" width="60%" align="center">
		...
		<input type="button" onClick="" value="Vaciar Carrito"></td>
		<input type="button" onClick="" value="Confirmar Compra"> </td> 
		<input type="button" onClick="" value="Agregar más alimentos"> <br>
