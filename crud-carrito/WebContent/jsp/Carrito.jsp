...
<head>
    ...
    <link rel = "icon" href = "${pageContext.request.contextPath}/Icons/cliente.svg" type = "image/x-icon"> 
	...
	<!-- Barra de navegación -->
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="top-bar">
			<div class="navbar-brand">
				<img src="${pageContext.request.contextPath}/Icons/cliente.svg" width="40" height="40" class="" alt="">
  				<a class="navbar-brand text-white">Cliente Yum</a>
			</div>
			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			    <div class="navbar-nav">
				      <a class="nav-item nav-link" href="#" id="nav-select">Carrito</a>
